...
public class ProductServiceImpl implements ProductService {
    ...
    public Product createProduct(ProductRequest request) {
        ...
        //specification
        if (request.getHasSpecification() && request.getProductSpecifications() != null) {
            product.setProductSpecifications(
                    productSpecificationRepository.saveAll(request.getProductSpecifications()));
        } else {
            product.setProductSpecifications(List.of());
        }
